...
public class PersonDto {
    ...
    public PersonDto(String name, String middleName, String lastName, LocalDate birthDate, String birthPlace, String curp, String phoneNumber, String sex, AddressDto addressDto) {
    }
