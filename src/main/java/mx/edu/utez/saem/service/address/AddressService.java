...
public class AddressService {
    ...
    public ResponseEntity<ApiResponse> save(AddressBean address){
        ...
        if(addressBeanOptional.isPresent()) //isPresent() si encuentra algo
    ...
    public ResponseEntity<ApiResponse> update(AddressBean address){
        Optional<AddressBean> foundCategory = repository.findById(address.getId());
    ...
    public ResponseEntity<ApiResponse> delete(Long id) {
        Optional<AddressBean> foundCategory = repository.findById(id);
        if (foundCategory.isPresent() ) {
            repository.deleteById(id);
            return new ResponseEntity<>(new ApiResponse(HttpStatus.OK, false, "Fecha Eliminada"), HttpStatus.OK);
        }
