...
const EditMedical = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object().shape({
            ...
            name: yup.string().required('Campo obligatorio').min(3, 'Mínimo 3 caracteres').max(45, 'Maximo 45 caracteres').matches(/^[a-zA-Z0-9\s]+$/, 'No se permiten caracteres especiales'),
            surname: yup.string().required('Campo obligatorio').min(3, 'Mínimo 3 caracteres').max(45, 'Maximo 45 caracteres').matches(/^[a-zA-Z0-9\s]+$/, 'No se permiten caracteres especiales'),
            ...
            curp: yup.string().required('Campo obligatorio').min(18, 'Mínimo 18 caracteres').max(18, 'Maximo 18 caracteres').matches(/^[a-zA-Z0-9\s]+$/, 'No se permiten caracteres especiales'),
