...
const EditPerson = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object().shape({
            ...
            curp: yup.string().required('Campo obligatorio').min(3, 'Minimo 18 caracteres').max(18, 'Maximo 18 caracteres').matches(/^[a-zA-Z0-9\sáéíóúÁÉÍÓÚ_]+$/, 'No se permiten caracteres especiales'),
