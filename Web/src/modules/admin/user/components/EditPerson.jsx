...
const EditPerson = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object().shape({
            ...
            password: yup.string().required('Campo obligatorio').min(8, 'Mínimo 8 caracteres').matches(/^[a-zA-Z0-9\s]+$/, 'No se permiten caracteres especiales'),
            confirmPassword: yup.string().required('Campo obligatorio').min(8, 'Mínimo 8 caracteres').test("password-matches", "Las contraseñas no coinciden", function (value) { return value === this.parent.password }).matches(/^[a-zA-Z0-9\s]+$/, 'No se permiten caracteres especiales'),
            ...
            surname: yup.string().required('Campo obligatorio').min(3, 'Minimo 3 caracteres').max(45, 'Máximo 45 caracteres').matches(/^[a-zA-Z0-9\s]+$/, 'No se permiten caracteres especiales'),
            lastname: yup.string().min(3, 'Minimo 3 caracteres').max(45, 'Máximo 45 caracteres').matches(/^[a-zA-Z0-9\s]+$/, 'No se permiten caracteres especiales'),
