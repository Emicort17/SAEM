...
const RegisterPerson = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object().shape({
            ...
            birthplace: yup.string().required('Campo obligatorio'),
                ...
                <form id='patientForm' name='patientForm' style={{ width: '100%', padding: '20px', border: '1px solid #ccc', color: '#03104A', borderRadius: '10px', marginRight: '20px' }} noValidate onSubmit={formik.handleSubmit} className='p-5'>
                    ...
                    <div className='w-full flex flex-row  justify-between px-5 py-5'>
                        ...
                        <div className='flex flex-col gap-3'>
                            ...
                            <div className='flex-col-6 pb-2'>
                                <Label  htmlFor='municipio' className='font-bold' value='Municipio'/>
                                <Select  style={{ backgroundColor: '#E6ECF1', color: '#03104A' }} id="municipio" name="municipio" value={formik.values.municipio} onChange={formik.handleChange}>
                            ...
                            <div className='flex flex-row justify-between space-x-3'>
                                <div className='flex-col-6 pb-2'>
                                    <Label style={{color: '#03104A'}} htmlFor='interiorNumber' className='font-bold'
                                ...
                                <div className='flex-col-6 pb-2'>
                                    <Label style={{color: '#03104A'}} htmlFor='exteriorNumber' className='font-bold'
                            ...
                            <div className='flex-col-6 pb-2'>
                                <Label style={{color: '#03104A'}} htmlFor='calle2' className='font-bold'
                                       value='Calle 2'/>
                                <TextInput style={{backgroundColor: '#E6ECF1'}}
                                           type='calle2'
                                           title="calle2"
                            ...
                            <div className='flex-col-6 pb-2'>
                                <Label style={{color: '#03104A'}} htmlFor='calle3' className='font-bold'
                                       value='Calle 3'/>
                                <TextInput style={{backgroundColor: '#E6ECF1'}}
                                           type='calle3'
                                           title="calle3"
                        ...
                        <div className='flex flex-col gap-3 w-72'>
                            ...
                            <div className=' pb-2'>
                                ...
                                <TextInput style={{backgroundColor: '#E6ECF1'}} type="text" placeholder="Correo"
                                           id="email" name="email"
