                ...
                <form id='doctorForm' name='doctorForm' style={{ width: '100%', padding: '20px', border: '1px solid #ccc', color: '#03104A', borderRadius: '10px', marginRight: '20px' }} noValidate onSubmit={formik.handleSubmit} className='p-5'>
                    ...
                    <div className='w-full flex flex-row  justify-between px-5 py-5'>
                        ...
                        <div className='flex flex-col gap-3 w-1/2' >
                            ...
                            <h3 className='font-bold text-2xl text-center'>Médicos</h3>
                            ...
                            <div className='grid-col-6 pb-2'>
                                <Label  style={{ backgroundColor: '#E6ECF1', color: '#03104A' }} htmlFor='birthdate' className='font-bold' value='Fecha de nacimiento' />
                                <TextInput style={{ backgroundColor: '#E6ECF1' }}
                                           type='date'
                            ...
                            <div className='grid-col-7'>
                                ...
                                <Select  style={{ backgroundColor: '#E6ECF1', color: '#03104A' }} id="sex" name="sexo" value={formik.values.sexo} onChange={formik.handleChange}>
                            ...
                            <div className='grid-col-6 pb-2'>
                                <Label htmlFor='birthplace' className='font-bold' value='Lugar de nacimiento' />
